!(function () {
  ...
  var r,
    a = (function () {
      ...
      return (
        ...
        (e.prototype.emit = function (e, t, n) {
          if (n) {
            if (!e) return;
            -1 !== this._cache.indexOf(n)
              ? this._emit(e, t)
              : (this._hooksCache.hasOwnProperty(n) ||
                  (this._hooksCache[n] = {}),
                this._hooksCache[n].hasOwnProperty(e) ||
                  (this._hooksCache[n][e] = []),
                this._hooksCache[n][e].push(t));
          } else this._emit(e, t);
        }),
        (e.prototype._emit = function (e, t) {
          e &&
            ...
            i([], o(this._hooks[e])).forEach(function (e) {
              try {
                e(t);
              } catch (e) {}
            });
    ...
    h =
      ((r = +Date.now() + Number("".concat(Math.random()).slice(2, 8))),
      function () {
        return (r += 1);
      }),
    f = function (e, t, n, o) {
      e.addEventListener
        ...
        : e.attachEven
        ? e.attachEven("on".concat(t), n)
        : (e["on".concat(t)] = n);
    },
    p = function (e, t, n, o) {
      e.addEventListener
        ? e.removeEventListener(t, n, o)
        : e.attachEven && e.detachEven("on".concat(t), n);
    },
    d = function (e) {
    ...
    E = function (e) {
      for (var t = 0, n = 0, o = (e += "").length, i = 0; i < o; i++)
        ((t = 31 * t + e.charCodeAt(n++)) > 0x7fffffffffff ||
          t < -0x800000000000) &&
          (t &= 0xffffffffffff);
    ...
    S = function () {
      ...
      return (
        -1 !== e.indexOf("Microsoft Internet Explorer") &&
        (-1 !== t.indexOf("MSIE 8.0") ||
          -1 !== t.indexOf("MSIE 7.0") ||
    ...
    w = function () {
      ...
      return (
        -1 !== e.indexOf("Microsoft Internet Explorer") &&
        (-1 !== t.indexOf("MSIE 8.0") || -1 !== t.indexOf("MSIE 9.0"))
      );
    },
    k = function () {
      var e = window.navigator.appName,
        ...
        return (function n(o) {
          ...
          function r(t, n, r) {
            if ("undefined" != typeof document) {
              "number" ==
                typeof (r = e({ path: "/" }, i.defaults, r)).expires &&
  ...
  var R = {
      ...
      setCookie: function (e, t, n, o) {
        try {
          var i = o || document.domain,
            r = +new Date() + n;
          O.set(e, t, { expires: new Date(r), path: "/", domain: i });
        } catch (e) {}
      },
      removeCookie: function (e, t) {
        try {
          O.remove(e, { path: "/", domain: t || "" });
        } catch (e) {}
      },
    ...
    x = (function () {
      function e(e, t) {
        this._storage =
          t && "session" === t ? M : !e && R.isSupportLS ? R : new I();
      }
      return (
        (e.prototype.getItem = function (e) {
      ...
      return (
        (e.prototype.init = function () {
          var e = window.navigator.userAgent,
            ...
            r = "web";
          (-1 === this.appVersion.indexOf("Mobile") &&
            -1 === this.appVersion.indexOf("Android") &&
            -1 === this.appVersion.indexOf("iPhone") &&
            -1 === this.appVersion.indexOf("iPad") &&
            -1 === this.appVersion.indexOf("mini")) ||
            (r = "wap"),
            (this.utm = (function (e, t, n, o) {
              var i = new x(!1),
                r = new x(!1, "session"),
              ...
              try {
                ...
                for (var f in u)
                  u[f] &&
                    ...
                    (h = !0));
                if (h)
                  r.setItem(s, "1"), i.setCookie(a, JSON.stringify(c), o, n);
                else {
        ...
        (e.prototype.browser = function () {
          ...
          return (
            -1 !== i.indexOf("Edge") || -1 !== i.indexOf("Edg")
              ? ((n = "Microsoft Edge"),
                -1 !== i.indexOf("Edge")
                  ? ((e = i.indexOf("Edge")), (o = i.substring(e + 5)))
                  : ((e = i.indexOf("Edg")), (o = i.substring(e + 4))))
              : -1 !== i.indexOf("MSIE") || -1 !== i.indexOf("Trident")
              ? ((n = "Microsoft Internet Explorer"),
                -1 !== i.indexOf("MSIE")
                  ? ((e = i.indexOf("MSIE")), (o = i.substring(e + 5, e + 9)))
                  : ((e = i.indexOf("rv")), (o = i.substring(e + 3, e + 7))))
              : -1 !== (e = i.indexOf("Lark"))
              ? ((n = "Lark"), (o = i.substring(e + 5, e + 11)))
              : -1 !== (e = i.indexOf("MetaSr"))
              ? ((n = "sougoubrowser"), (o = i.substring(e + 7, e + 10)))
              : -1 !== i.indexOf("MQQBrowser") || -1 !== i.indexOf("QQBrowser")
              ? ((n = "qqbrowser"),
                -1 !== i.indexOf("MQQBrowser")
                  ? ((e = i.indexOf("MQQBrowser")),
                    (o = i.substring(e + 11, e + 15)))
                  : -1 !== i.indexOf("QQBrowser") &&
                    ((e = i.indexOf("QQBrowser")),
                    (o = i.substring(e + 10, e + 17))))
              : -1 !== i.indexOf("Chrome")
              ? -1 !== (e = i.indexOf("MicroMessenger"))
                ? ((n = "weixin"), (o = i.substring(e + 15, e + 20)))
                : -1 !== (e = i.indexOf("360"))
                ? ((n = "360browser"),
                  (o = i.substring(i.indexOf("Chrome") + 7)))
                : -1 !== i.indexOf("baidubrowser") ||
                  -1 !== i.indexOf("BIDUBrowser")
                ? (-1 !== i.indexOf("baidubrowser")
                    ? ((e = i.indexOf("baidubrowser")),
                      (o = i.substring(e + 13, e + 16)))
                    : -1 !== i.indexOf("BIDUBrowser") &&
                      ((e = i.indexOf("BIDUBrowser")),
                      (o = i.substring(e + 12, e + 15))),
                  (n = "baidubrowser"))
                : -1 !== (e = i.indexOf("xiaomi"))
                ? -1 !== i.indexOf("openlanguagexiaomi")
                  ? ((n = "openlanguage xiaomi"),
                    (o = i.substring(e + 7, e + 13)))
                  : ((n = "xiaomi"), (o = i.substring(e - 7, e - 1)))
                : -1 !== (e = i.indexOf("TTWebView"))
                ? ((n = "TTWebView"), (o = i.substring(e + 10, e + 23)))
                : -1 !== (e = i.indexOf("Chrome"))
                ? ((n = "Chrome"), (o = i.substring(e + 7)))
                : -1 !== (e = i.indexOf("Chrome")) &&
                  ((n = "Chrome"), (o = i.substring(e + 7)))
              : -1 !== i.indexOf("Safari")
              ? -1 !== (e = i.indexOf("QQ"))
                ? ((n = "qqbrowser"), (o = i.substring(e + 10, e + 16)))
                : -1 !== (e = i.indexOf("Safari")) &&
                  ((n = "Safari"),
                  (o = i.substring(e + 7)),
                  -1 !== (e = i.indexOf("Version")) && (o = i.substring(e + 8)))
              : -1 !== (e = i.indexOf("Firefox"))
              ? ((n = "Firefox"), (o = i.substring(e + 8)))
              : -1 !== (e = i.indexOf("MicroMessenger"))
              ? ((n = "weixin"), (o = i.substring(e + 15, e + 20)))
              : -1 !== (e = i.indexOf("QQ"))
              ? ((n = "qqbrowser"), (o = i.substring(e + 3, e + 8)))
              : -1 !== (e = i.indexOf("Opera")) &&
                ((n = "Opera"),
                (o = i.substring(e + 6)),
                -1 !== (e = i.indexOf("Version")) && (o = i.substring(e + 8))),
        ...
        (e.prototype.os = function () {
          ...
          if (S());
            ...
            var s = function (e, t) {
              ...
              c = function (e, t) {
                var n = RegExp(
                  "(?:^|[^A-Z0-9-_]|[^A-Z0-9-]_|sprd-)(?:".concat(e, ")"),
                  "i"
                ).exec(t);
            ...
            switch (o) {
              ...
              case "iOS":
                (e = this.isNewIpad()
                  ...
                  : (e = /OS (\d+)_(\d+)_?(\d+)?/.exec(this.appVersion))
                  ? ""
                      .concat(e[1], ".")
                      .concat(e[2], ".")
                      .concat(0 | e[3])
  ...
  var N,
    ...
    P =
      "https://lf3-data.volccdn.com/obj/data-static/log-sdk/collect/visual-editor-rangers.js",
    z =
      "https://lf3-data.volccdn.com/obj/data-static/log-sdk/collect/visual-ab-core.js",
    j =
      "https://lf3-data.volccdn.com/obj/data-static/log-sdk/collect/heatmap-core";
  !(function (e) {
    (e.Init = "init"),
      (e.Config = "config"),
      (e.Start = "start"),
      (e.ReStart = "re-start-sdk"),
      (e.Stop = "stop-sdk"),
      (e.Ready = "ready"),
      (e.CloudReady = "cloud-ready"),
      ...
      (e.SubmitVerifyH = "submit-verify-h5"),
      (e.BindToken = "bind-token"),
      (e.BindTokenReady = "bind-token-ready"),
      (e.CustomHeader = "custom-request-header"),
      (e.Stay = "stay"),
      ...
      (e.TrackDuration = "track-duration"),
      (e.TrackDurationStart = "track-duration-start"),
      (e.TrackDurationEnd = "track-duration-end"),
      (e.TrackDurationPause = "track-duration-pause"),
      (e.TrackDurationResume = "tracl-duration-resume"),
      (e.Autotrack = "autotrack"),
      (e.AutotrackReady = "autotrack-ready"),
      (e.SetExposureType = "set-exposure-type"),
      (e.CepReady = "cep-ready"),
      (e.TracerReady = "tracer-ready"),
      (e.EncryptData = "encrypt-data"),
      (e.LogSettingReady = "logsetting-ready"),
      (e.SetResource = "set-resource");
  })(N || (N = {})),
    (function (e) {
      (e.DEBUGGER_MESSAGE = "debugger-message"),
  ...
  var V = N,
    ...
    W = (function () {
      function t(e, t) {
        ...
        (this.configKey = "__tea_cache_config_".concat(t.app_id)),
          (this.sessionStorage = new x(!1, "session")),
          (this.localStorage = new x(!1, "local")),
          t.configPersist &&
            ((this.configPersist = !0),
            (this.storage =
              1 === t.configPersist ? this.sessionStorage : this.localStorage));
        var r = this.localStorage.getItem(i);
        r && 1 == r
          ? (this.is_first_time = !1)
          : ((this.is_first_time = !0), this.localStorage.setItem(i, "1")),
          (this.envInfo = {
            user: {
              user_unique_id: K,
              user_type: K,
            ...
            header: {
              ...
              carrier: K,
              resolution: ""
                .concat(o.screen_width, "x")
                .concat(o.screen_height),
              browser: o.browser,
      ...
      return (
        (t.prototype.initDomain = function () {
        ...
        (t.prototype.initABData = function () {
          ...
          if (this.initConfig.ab_cross) {
            var n = this.localStorage.getCookie(
              e,
        ...
        (t.prototype.getUrl = function (e) {
          ...
          return (
            this.initConfig.caller &&
              (n = "?sdk_version="
                .concat(B, "&sdk_name=web&app_id=")
                .concat(this.initConfig.app_id, "&caller=")
                .concat(this.initConfig.caller)),
            this.initConfig.report_url
              ? "".concat(this.initConfig.report_url).concat(n)
              : "".concat(this.getDomain()).concat(t).concat(n)
          );
        }),
        ...
        (t.prototype.changeReferInfo = function (e) {
          var t = e;
          this.set({ referrer: t.referrer });
          var n = "";
          try {
            n = new URL(t.referrer).host;
          } catch (e) {}
          this.set({ referrer_host: n || this.envInfo.header.referrer_host });
        }),
        (t.prototype.set = function (t) {
          var n = this;
          Object.keys(t).forEach(function (o) {
            if (
              ((void 0 !== t[o] && null !== t[o]) || n.delete(o),
              "traffic_type" === o &&
                n.isLast &&
                (n.envInfo.header.custom.$latest_traffic_source_type = t[o]),
              "evtParams" === o)
            )
              n.evtParams = e(e({}, n.evtParams || {}), t.evtParams || {});
            else if ("_staging_flag" === o)
              n.evtParams = e(e({}, n.evtParams || {}), {
                _staging_flag: t._staging_flag,
              });
            else if ("reportErrorCallback" === o && "function" == typeof t[o])
              n.reportErrorCallback = t[o];
            else {
              var i = "",
                r = "";
              if (o.indexOf(".") > -1) {
              ...
              i
                ...
                : Object.hasOwnProperty.call(n.envInfo.user, o)
                ? (["user_type", "ip_addr_id"].indexOf(o) > -1
                    ? (n.envInfo.user[o] = t[o] ? Number(t[o]) : t[o])
                    : [
                        "user_id",
                        "web_id",
                        "user_unique_id",
                    ...
                    ? (n.envInfo.user[o] = t[o] ? String(t[o]) : t[o])
                    : ["user_is_auth", "user_is_login"].indexOf(o) > -1
                    ? (n.envInfo.user[o] = Boolean(t[o]))
                    : "device_id" === o && (n.envInfo.user[o] = t[o]),
                  n.collect.emit(U.DEBUGGER_MESSAGE, {
                    type: U.DEBUGGER_MESSAGE_SDK,
                    info: "SDK ä¿®æ”¹äº†å…¬å…±å‚æ•°",
                    level: "info",
                    time: Date.now(),
                    infoType: "sdk",
                    secType: "USER",
                ...
                : Object.hasOwnProperty.call(n.envInfo.header, o)
                ? ((n.envInfo.header[o] = t[o]),
                  n.collect.emit(U.DEBUGGER_MESSAGE, {
                    type: U.DEBUGGER_MESSAGE_SDK,
                    info: "SDK ä¿®æ”¹äº†å…¬å…±å‚æ•°",
                    level: "info",
        ...
        (t.prototype.getSettingData = function (e) {
          if (this.logSettingConfig && !u(this.logSettingConfig[e]))
            return this.logSettingConfig[e];
        }),
    ...
    X = (function () {
      ...
      return (
        ...
        (e.prototype.error = function (e) {
          this.isLog &&
            console.error("[instance: ".concat(this.name, "]") + " " + e);
        }),
    ...
    $ = (function () {
      function e(e, t) {
        (this.native =
          e.enable_native || e["evitaN".split("").reverse().join("")]),
          (this.os = t.get("os_name"));
      }
      var t = e.prototype;
      return (
              ...
              (AppLogBridge
                ? (console.log("AppLogBridge is injected"),
                  AppLogBridge.osName
                    ...
                    : (this.os = this.os),
                  !0)
                : (console.log("AppLogBridge is not inject"), !1))
            );
          } catch (e) {
        ...
        (t.setConfig = function (e) {
          ...
          try {
            Object.keys(e).forEach(function (n) {
              "user_unique_id" === n
                ? t.setUserUniqueId(e[n])
                : e[n]
                ? t.addHeaderInfo(n, e[n])
                : t.removeHeaderInfo(n);
            });
          } catch (e) {
        ...
        (t.getVar = function (e, t, n) {
          try {
            "harmonyos" === this.os
              ? n(AppLogBridge.getABTestConfigValueForKey(e, t))
              : "android" === this.os
              ? n(AppLogBridge.getABTestConfigValueForKey(e, t))
              : AppLogBridge.getABTestConfigValueForKey(e, t, function (e) {
                  n(e);
                });
          } catch (e) {
        ...
        (t.getAllVars = function (e) {
          try {
            "harmonyos" === this.os
              ? e(AppLogBridge.getAllAbTestConfigs())
              : "android" === this.os
              ? e(AppLogBridge.getAllAbTestConfigs())
              : AppLogBridge.getAllAbTestConfigs(function (t) {
                  e(t);
                });
          } catch (t) {
        ...
        (t.getAbSdkVersion = function (e) {
          try {
            "harmonyos" === this.os
              ? e(AppLogBridge.getAbSdkVersion())
              : "android" === this.os
              ? e(AppLogBridge.getAbSdkVersion())
              : AppLogBridge.getAbSdkVersion(function (t) {
                  e(t);
                });
          } catch (t) {
    ...
    try {
      ...
      if (window.XDomainRequest && w()) {
        ...
        u.open(h, e, !0),
          ...
          a && u.setRequestHeader("X-MCS-AppKey", "".concat(a)),
          o && (u.withCredentials = !0),
          n &&
            ((u.timeout = n),
            (u.ontimeout = function () {
              r && r(t, Q.TIMEOUT);
  ...
  var Z = 4e3,
          ...
          var r = (function (e) {
              ...
              for (var n in e)
                e.hasOwnProperty(n) &&
                  ...
                  (t += "&"
                    .concat(n, "=")
                    .concat(encodeURIComponent(JSON.stringify(e[n]))));
    ...
    oe = (function () {
      ...
      return (
        (e.prototype.apply = function (e, t) {
          var n = this;
          (this.collect = e),
            (this.storage = new x(!1, "session")),
            (this.sessionKey = "__tea_session_id_".concat(t.app_id)),
            (this.expireTime = t.expireTime || 18e5),
            (this.disableSession = t.disable_session),
            this.disableSession ||
              (this.setSessionId(),
              this.collect.on(V.SessionReset, function () {
                n.resetSessionId();
              }),
        ...
        (e.prototype.updateSessionIdTime = function () {
          ...
          if (e && e.sessionId) {
            ...
            Date.now() - t > this.expireTime
              ? (e = { sessionId: ne(), timestamp: Date.now() })
        ...
        (e.prototype.setSessionId = function () {
          ...
          t && t.sessionId
            ...
            : (t = { sessionId: ne(), timestamp: Date.now() }),
        ...
        (e.prototype.resetSessionId = function () {
          var e = { sessionId: ne(), timestamp: Date.now() };
          this.storage.setItem(this.sessionKey, e);
        }),
    ...
    ie = (function () {
      function t(e, t) {
        ...
        (this.MAX_LEVEL = 3),
          ...
          (this.eventCache = []),
          t.enable_track_id &&
            ((this.MAX_LEVEL = t.track_level || 3),
            e.on(V.SetResource, function (e) {
              n.metaResource = e;
            }));
      }
      return (
        (t.prototype.handleMetaResource = function (t) {
          var n = this;
          return Object.keys(this.metaResource).length
                  ...
                  for (var l in c)
                    if (n.metaResource.hasOwnProperty(l)) {
                      ...
                      if (h.length && h.includes(u)) {
                        ...
                        (c.ubt_source_id = f),
                          n.eventCache.length &&
                            (c.ubt_source = i([], o(n.eventCache)).reverse()),
                          n.eventCache.length >= n.MAX_LEVEL &&
                            n.eventCache.shift(),
                          n.eventCache.push({
                            event: r,
      ...
      return (
        (t.prototype.apply = function (e, t) {
          ...
          (this.collect = e),
            ...
            (this.cacheStorgae = new x(!0)),
            (this.localStorage = new x(!1)),
            (this.trackId = new ie(e, t)),
            (this.maxReport = t.max_report || 20),
            (this.reportTime = t.reportTime || 30),
            (this.timeout = t.timeout || 1e5),
            (this.reportUrl = this.configManager.getUrl("event")),
            (this.eventKey = "__tea_cache_events_".concat(
              this.configManager.get("app_id")
            )),
            (this.beconKey = "__tea_cache_events_becon_".concat(
              this.configManager.get("app_id")
            )),
            (this.abKey = "__tea_sdk_ab_version_".concat(
              this.configManager.get("app_id")
            )),
            (this.refer_key = "__tea_cache_refer_".concat(
              this.configManager.get("app_id")
            )),
            this.collect.on(V.Ready, function () {
              n.reportAll(!1);
            }),
        ...
        (t.prototype.event = function (e) {
          ...
          try {
            var n = this.cacheStorgae.getItem(this.eventKey) || [],
              r = i(i([], o(e)), o(n));
            if (
              (this.cacheStorgae.setItem(this.eventKey, r),
              this.reportTimeout && clearTimeout(this.reportTimeout),
              r.length >= this.maxReport)
            )
              this.report(!1);
            else {
        ...
        (t.prototype.merge = function (t, n) {
          var o,
            ...
            s = a.header,
            c = a.user;
          (s.custom.origin_referrer =
            null === (o = this.collect.configManager) || void 0 === o
              ? void 0
              : o.getCommonInfo("referrer")),
            (s.custom.origin_referrer_host =
              null === (i = this.collect.configManager) || void 0 === i
                ? void 0
                : i.getCommonInfo("referrer_host")),
          ...
          try {
              ...
              try {
                if (
                  (Object.keys(l).length &&
                    !n &&
                    (t.params = e(e({}, t.params), l)),
                  r.collect.dynamicParamsFilter && !n)
                ) {
                ...
                return (
                  a &&
                    i &&
                    (r.config.disable_ab_reset
                      ? (t.ab_sdk_version = a)
                      : i.uuid === c.user_unique_id && (t.ab_sdk_version = a)),
                  (t.session_id = r.collect.sessionManager.getSessionId()),
                  (t.params = JSON.stringify(t.params)),
                  r.blockEvent(t.event) && r.whiteEvent(t.event)
                );
              } catch (e) {
                return (
                  console.warn(
                    "filter merge event: ".concat(
                      t && t.event,
                      " error, pls check"
                    ),
                    e && e.message
                  ),
                  r.collect.emit(U.DEBUGGER_MESSAGE, {
                    type: U.DEBUGGER_MESSAGE_SDK,
                    info: "SDK å¤„ç†Eventæ•°æ®å¼‚å¸¸",
                    level: "error",
                    time: Date.now(),
                    data: e.message,
                    infoType: "sdk",
            ...
            if (
              (this.config.enable_track_id &&
                (f = this.trackId.handleMetaResource(f)),
              !Object.keys(c).length)
            )
              return console.warn("user info errorï¼Œcant report"), h;
            this.config.enable_anonymousid && delete c.web_id;
            var p = JSON.parse(
              JSON.stringify({ events: f, user: c, header: s })
            );
            (p.local_time = Math.floor(Date.now() / 1e3)),
              (p.verbose = 1),
              (p.user_unique_type = this.config.enable_ttwebid
          ...
          try {
            ...
            if (this.config.enable_logsetting) {
              var n = this.blockList,
                o =
                  this.collect.configManager.getSettingData(
                    "blocklist_events"
                  ) || [];
              t = n.concat(
                o.filter(function (e) {
        ...
        (t.prototype.whiteEvent = function (e) {
          ...
          try {
            return (
              (null === (t = this.whiteList) || void 0 === t
                ? !void 0
                : !t.length) || !!this.whiteList.includes(e)
            );
          } catch (e) {
            return !0;
          }
            ...
            e.forEach(function (e) {
              try {
                ...
                n.config.filter &&
                  ...
                  n.collect.eventFilter &&
                    o &&
                    ((o = n.collect.eventFilter(o)) ||
                ...
                var c = u(
                  n.collect.configManager.getSettingData("request_timeout")
                )
                  ? n.timeout
                  : n.collect.configManager.getSettingData("request_timeout");
                n.collect.requestManager.useRequest({
                  ...
                  fail: function (e, t) {
                    n.configManager.get("reportErrorCallback")(e, t),
                      ...
                      n.collect.emit(U.DEBUGGER_MESSAGE, {
                        type: U.DEBUGGER_MESSAGE_EVENT,
                        info: "åŸ‹ç‚¹ä¸ŠæŠ¥ç½‘ç»œå¼‚å¸¸",
                        time: Date.now(),
                        data: r,
                        code: t,
                        failType: "ç½‘ç»œå¼‚å¸¸å¤±è´¥",
                        status: "fail",
                      });
                  },
                  timeout: c,
                  ...
                  n.collect.emit(V.SubmitVerifyH, i),
                  n.collect.emit(V.SubmitAfter, i);
              } catch (e) {
                console.warn(
                  "something error, ".concat(JSON.stringify(e.stack))
                ),
                  n.collect.emit(U.DEBUGGER_MESSAGE, {
                    type: U.DEBUGGER_MESSAGE_SDK,
                    info: "SDKå‘é€åŸ‹ç‚¹å‘ç”Ÿäº†å¼‚å¸¸",
                    level: "error",
                    time: Date.now(),
                    data: e.message,
                    infoType: "sdk",
        ...
        (t.prototype.updateFilter = function (e) {
          var t, n;
          (this.blockList =
            (null === (t = null == e ? void 0 : e.blocklist) || void 0 === t
              ? void 0
              : t.v3) || []),
            (this.whiteList =
              (null === (n = null == e ? void 0 : e.whitelist) || void 0 === n
                ? void 0
                : n.v3) || []);
        }),
        t
    ...
    se = (function () {
      function t() {
        (this.cacheToken = {}),
          (this.enableCookie = !1),
          (this.enableTTwebid = !1),
          (this.enableCustomWebid = !1),
          (this.enableAnonymousid = !1);
      }
      return (
        (t.prototype.apply = function (e, t) {
          var n = this;
          (this.collect = e),
            ...
            (this.storage = new x(!1)),
            (this.tokenKey = "__tea_cache_tokens_".concat(t.app_id)),
            (this.enableAnonymousid = t.enable_anonymousid),
            (this.enableTTwebid = t.enable_ttwebid),
            (this.enableCustomWebid = t.enable_custom_webid),
            (this.timeout = t.timeout || 3e5),
            this.collect.on(V.AnonymousId, function (e) {
              n.setAnonymousId(e);
            }),
        ...
        (t.prototype.checkStorage = function () {
          ...
          (this.tokenType =
            this.cacheToken && this.cacheToken._type_
              ...
              : "default"),
            "custom" !== this.tokenType ||
            this.enableCustomWebid ||
            this.enableAnonymousid
              ? this.enableAnonymousid
                ? this.completeAnonymous(this.cacheToken)
                : this.enableCustomWebid
                ? this.collect.on(V.CustomWebId, function () {
        ...
        (t.prototype.remoteWebid = function () {
          ...
          this.collect.requestManager.useRequest({
            ...
            success: function (t) {
              ...
              if (t && 0 === t.e)
                (n = t.web_id),
                  e.collect.emit(U.DEBUGGER_MESSAGE, {
                    type: U.DEBUGGER_MESSAGE_SDK,
                    info: "WEBIDè¯·æ±‚æˆåŠŸ",
                    logType: "fetch",
                    level: "info",
                    time: Date.now(),
                    data: t,
                ...
                var o = e.getLocalId();
                (n = o),
                  e.collect.configManager.set({ localWebId: o }),
                  e.collect.emit(V.TokenError),
                  e.collect.emit(U.DEBUGGER_MESSAGE, {
                    type: U.DEBUGGER_MESSAGE_SDK,
                    info: "WEBIDè¯·æ±‚è¿”å›žå€¼å¼‚å¸¸",
                    logType: "fetch",
                    level: "warn",
                    time: Date.now(),
                    data: t,
        ...
        (t.prototype.complete = function (e) {
          ...
          if (!t && !n)
            return (
              this.collect.emit(V.TokenError), void console.warn("token error")
            );
          (e.timestamp = Date.now()),
            0 === t.indexOf("9") && t.length > 18
              ? this.remoteWebid()
              : (this.collect.configManager.set({
                ...
                this.setStorage(e),
                (this.tokenReady = !0),
                this.collect.emit(V.TokenComplete));
        }),
        ...
        (t.prototype.setUuid = function (e) {
          if (e && -1 === ["null", "undefined", "Null", "None"].indexOf(e)) {
            ...
            if (t === n && t === o) return;
            this.configManager.set({ user_unique_id: t }),
              this.cacheToken
              ...
              this.collect.emit(V.TokenChange, { type: "uuid", id: e }),
              this.collect.emit(V.ProfileClear),
              this.collect.emit(V.SessionReset);
          } else this.clearUuid();
        }),
        (t.prototype.clearUuid = function () {
          if (!this.config.enable_ttwebid) {
            var e = this.enableAnonymousid
              ? this.configManager.get("anonymous_id")
              : this.configManager.get("web_id");
            this.configManager.get("user_unique_id") !== e &&
              (this.configManager.set({ user_unique_id: e }),
              (this.cacheToken.user_unique_id = e),
              (this.cacheToken.timestamp = Date.now()),
              this.setStorage(this.cacheToken),
              this.collect.emit(V.ProfileClear),
              this.collect.emit(V.TokenReset));
          }
        }),
          ...
          if (e && this.enableAnonymousid) {
            ...
            t !== e &&
              ((t !== n && n) ||
                ...
                (this.cacheToken.user_unique_id = e),
                this.collect.emit(V.TokenChange, { type: "uuid", id: e })),
              this.configManager.set({ anonymous_id: e }),
              (this.cacheToken.anonymous_id = e),
              this.collect.emit(V.TokenChange, { type: "anonymous_id", id: e }),
              this.setStorage(this.cacheToken));
          }
        }),
          ...
          if (e && !this.config.enable_ttwebid && !this.enableAnonymousid) {
            ...
            (n && n !== t) ||
              ...
              t !== e &&
                ...
                this.collect.emit(V.ProfileClear),
                this.collect.emit(V.TokenChange, { type: "webid", id: e })),
              (this.cacheToken.timestamp = Date.now()),
              this.setStorage(this.cacheToken);
          }
        }),
        (t.prototype.setStorage = function (e) {
          (e._type_ = this.enableCustomWebid ? "custom" : "default"),
            ...
            this.enableCookie || this.enableTTwebid
        ...
        (t.prototype.getTobId = function (e) {
          var t = this,
            n = {
              ...
              user_unique_id_type: this.configManager.get(
                "user_unique_id_type"
              ),
            };
          this.enableAnonymousid
            ? (n.anonymous_id = this.configManager.get("anonymous_id"))
            : (n.web_id = this.configManager.get("web_id"));
          var o = this.collect.cryptoData(n);
          this.collect.requestManager.useRequest({
      ...
      return (
        ...
        (e.prototype.useBeacon = function (e) {
          var t = e.url,
            ...
            o = e.success,
            i = e.fail;
          window.navigator.sendBeacon(t, JSON.stringify(n))
            ? o && o()
            : i && i(n, this.errorCode.BEACON_FALSE);
        }),
        (e.prototype.useRequest = function (e) {
          ...
          if (c && this.supportBeacon)
            this.useBeacon({ url: n, data: o, method: i, success: r, fail: a });
          else if ("fetch" !== this.requestType || h)
            try {
              var p = null;
              if (window.XDomainRequest && w()) {
                ...
                if (
                  ...
                  u && p.setRequestHeader("X-MCS-AppKey", "".concat(u)),
                  Object.keys(this.customHeader).length)
                )
                  for (var g in this.customHeader)
                    p.setRequestHeader(g, this.customHeader[g]);
                l && (p.withCredentials = !0),
                  s &&
                    ((p.timeout = s),
                    (p.ontimeout = function () {
                      a && a(o, t.errorCode.TIMEOUT);
                  ...
                  (p.onload = function () {
                    if (r) {
                      ...
                      if (p.responseText) {
                        ...
                        r(e, o, f),
                          t.collector.emit("http-ok", { data: o, status: f });
                      }
                    }
                  }),
                  (p.onerror = function () {
                    a && a(o, t.errorCode.XHR_ON),
                      t.collector.emit("http-error", { data: o, status: f }),
                      p.abort();
                  }),
                  p.send(JSON.stringify(o));
              }
              ...
              this.collector.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_SDK,
                info: "SDK useRequest å‘é€è¯·æ±‚å‘ç”Ÿäº†ä¸€äº›é—®é¢˜",
                level: "error",
                time: Date.now(),
                data: e.message,
                infoType: "sdk",
            ...
            this.useFetch({ url: n, data: o, method: i, success: r, fail: a });
        }),
        e
      );
    })(),
      ...
      return (
        (t.prototype.apply = function (e, t) {
          ...
          if (!S()) {
            (this.collect = e),
              (this.config = t),
              (this.duration = 6e4),
              (this.reportUrl = "".concat(
                e.configManager.getDomain(),
                "/profile/list"
              ));
            var o = e.Types,
              i = e.adapters.fetch;
            (this.fetch = i),
              (this.cache = {}),
              this.collect.on(o.ProfileSet, function (e) {
                n.setProfile(e);
              }),
        ...
        (t.prototype.report = function (e, t) {
          ...
          try {
            ...
            this.collect.requestManager.useRequest({
              ...
              this.collect.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_EVENT,
                info: "profile åŸ‹ç‚¹ä¸ŠæŠ¥æˆåŠŸ",
                time: Date.now(),
                data: o,
                code: 200,
                status: "success",
            ...
            this.collect.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "profile report å‘ç”Ÿäº†å¼‚å¸¸",
              level: "error",
              time: Date.now(),
              data: e.message,
              infoType: "sdk",
        ...
        (t.prototype.setProfile = function (t) {
          ...
          n &&
            ...
            (this.pushCache(n),
            this.report("__profile_set", e(e({}, n), { profile: !0 })));
        }),
        (t.prototype.setOnceProfile = function (t) {
          ...
          n &&
            Object.keys(n).length &&
            (this.pushCache(n),
            this.report("__profile_set_once", e(e({}, n), { profile: !0 })));
        }),
        (t.prototype.incrementProfile = function (t) {
          t
            ? this.report("__profile_increment", e(e({}, t), { profile: !0 }))
        ...
        (t.prototype.unsetProfile = function (t) {
          if (t) {
            var n = {};
            (n[t] = "1"),
              this.report("__profile_unset", e(e({}, n), { profile: !0 }));
        ...
        (t.prototype.appendProfile = function (t) {
          if (t) {
            ...
            for (var o in t)
              "string" == typeof t[o] ||
              "Array" === Object.prototype.toString.call(t[o]).slice(8, -1)
                ? (n[o] = t[o])
                : console.warn(
                    "please check the value of param: ".concat(
                      o,
                      ", must be string or array !!!"
                    )
                  );
            Object.keys(n).length &&
              this.report("__profile_append", e(e({}, n), { profile: !0 }));
          } else console.warn("please check the params, must be object!!!");
        }),
        (t.prototype.pushCache = function (e) {
          var t = this;
          Object.keys(e).forEach(function (n) {
            t.cache[n] = { val: t.clone(e[n]), timestamp: Date.now() };
          });
        }),
        (t.prototype.formatParams = function (e, t) {
          ...
          try {
            ...
            for (var i in e)
              "string" == typeof e[i] ||
              "number" == typeof e[i] ||
              "Array" === Object.prototype.toString.call(e[i]).slice(8, -1)
                ? (o[i] = e[i])
                : console.warn(
                    "please check the value of params:".concat(
                      i,
                      ", must be string,number,Array !!!"
                    )
                  );
            var r = Object.keys(o);
            if (!r.length) return;
      ...
      return (
        (e.prototype.apply = function (e, t) {
          if (t.enable_logsetting) {
            ...
            (this.setKey = "__applog_web_logsetting_".concat(t.app_id)),
              (this.cacheStorgae = new n(!1)),
              this.check();
        ...
        (e.prototype.check = function () {
          ...
          e && Object.keys(e).length
            ? (null == e ? void 0 : e.timestamp) < Date.now() - this.expire
              ? this.setting()
              : (this.setLocalData(e), this.setting(!0))
            : this.setting();
        }),
        (e.prototype.setting = function (e) {
          var t = this;
          e
            ? this.collect.emit(V.LogSettingReady)
            : this.collect.requestManager.useRequest({
                url: ""
                  .concat(this.collect.configManager.getDomain())
                  .concat(this.setUrl),
                data: {
                  magic_tag: "ss_app_log",
                  header: { aid: this.config.app_id, platform: "web" },
                },
                timeout: 3e4,
                success: function (e) {
                  (null == e ? void 0 : e.config) && t.setLocalData(e.config),
        ...
        (e.prototype.setLocalData = function (e) {
          this.collect.configManager.setSettingData(e),
            this.cacheStorgae.setItem(this.setKey, e);
        }),
        e
      );
    })(),
      ...
      return (
            ...
            this.collect.remotePlugin.forEach(function (t, n) {
              if ("sdk" === t)
                if (fe.hasOwnProperty(n)) {
                  var o = fe[n].object,
                    i = ""
                      .concat(fe[n].src[e.channel], "?query=")
                      .concat(Date.now());
                  e.exist(n, o, i);
                } else
                  console.warn(
                    "your ".concat(
                      n,
                      " is not existï¼Œplease check plugin name"
                    )
                  );
              else
                "object" == typeof t &&
                  (t.src
                    ? e.exist(n, t.call, t.src)
                    : e.process(n, t.instance, "INSTANCE"));
            });
          } catch (e) {
            this.collect.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
        ...
        (e.prototype.process = function (e, t, n) {
          try {
            if (n) {
              var o = new t();
              o.apply && o.apply(this.collect, this.config),
                console.log("excude ".concat(e, " success"));
            ...
            this.collect.emit(U.DEBUGGER_MESSAGE, {
              ...
              console.log(
                "excude ".concat(e, " error, message:").concat(t.message)
              );
          }
        }),
    ...
    ve = (function () {
      function e(e, t) {
        if (
          ...
          (this.sendAlready = !1),
          t.enable_debug &&
            "Microsoft Internet Explorer" !== e.configManager.get("browser"))
        ) {
          ...
          (this.cacheStorgae = new n(!1)),
            (this.loadUrl =
              t.devtool_url ||
              "https://lf-static.applogcdn.com/obj/applog-sdk-static/log-sdk/collect/devtool/debug-web.v2.0.0.js"),
      ...
      return (
            ...
            (this.info = [
              {
                ...
                type: 1,
                content: [
                  { name: "app_id", desc: "APP_ID", value: this.config.app_id },
                  {
                    name: "channel",
                    desc: "CHANNEL",
                  ...
                  { name: "sdk_version", desc: "SDKç‰ˆæœ¬", value: B },
                  { name: "sdk_type", desc: "SDKå¼•å…¥æ–¹å¼", value: "script" },
                ],
              },
              {
                title: "ç”¨æˆ·ä¿¡æ¯",
                ...
                content: [
                  {
                    ...
                    desc: "UUID",
                    value:
                      this.collect.configManager.get("user").user_unique_id ||
                      "",
                  },
                  {
                    name: "web_id",
            ...
            var e = this.getInfo("ab"),
              t = [
                ...
                },
                {
                  ...
                  desc: "A/BåŸŸå",
                  value:
                    this.config.ab_channel_domain || d(L[this.config.channel]),
                },
                {
                  name: "all_values",
                  desc: "å…¨éƒ¨é…ç½®",
        ...
        (e.prototype.setSecondInfo = function (e, t, n) {
          ...
          if (
            ...
            var r = { name: t, value: n, desc: t.toLocaleUpperCase() };
            o.content.push(r);
          }
          this.setInfo(e, o);
        }),
          ...
          this.collect.on(U.DEBUGGER_MESSAGE, function (t) {
            switch (t.type) {
              case U.DEBUGGER_MESSAGE_SDK:
                ...
                if (
                  (t.data && (n.desc = { content: JSON.stringify(t.data) }),
                  e.updateLog(n),
                ...
                else if ("USER" === t.secType)
                  e.setSecondInfo(
                    "user",
                    "user_unique_id" === t.common ? "uuid" : t.common,
                  ...
                  e.setSecondInfo(
                    "common",
                    t.common,
                    "custom" === t.common ? JSON.stringify(o) : o
                  );
                }
                ...
                if (t.data && t.data.length) {
                  ...
                  r.forEach(function (n) {
                    (n.checkShow = !0),
                      ...
                      (n.focusShow = !0),
                      (n.status = t.status),
                      (n.type = e.filterEvent.has(n.event) ? "sdk" : "cus"),
                      (n.verifyType = t.verifyType ? "verify" : "no"),
                      (n.info = ""),
                      "fail" === t.status &&
                        (n.info = {
                          message: "code: "
                            .concat(t.code, "ï¼Œ msg: ")
                            .concat(t.msg || t.failType),
                        });
                  }),
                    e.updateEvent(i);
                }
  ...
  var me = (function () {
      function t(e) {
        (this.disableAutoPageView = !1),
          ...
          (this.sdkReady = !1),
          (this.name = e),
          (this.hook = new a(this)),
          (this.logger = new X(e)),
          (this.remotePlugin = new Map()),
          (this.Types = V),
          (this.adapters.fetch = Y),
          (this.adapters.storage = x);
      }
      return (
        (t.usePlugin = function (e, n, o) {
          if (n) {
            for (var i = !1, r = 0, a = t.plugins.length; r < a; r++) {
              if (t.plugins[r].name === n) {
                (t.plugins[r].plugin = e),
                  (t.plugins[r].options = o || {}),
                  (i = !0);
                break;
              }
            }
            i || t.plugins.push({ name: n, plugin: e, options: o });
          } else t.plugins.push({ plugin: e });
        }),
        (t.prototype.usePlugin = function (e, t, n) {
          e &&
            (this.remotePlugin.get(e)
              ? console.info("your sdk version has ".concat(e, " already ~"))
              : t
              ? "string" == typeof t
                ? this.remotePlugin.get(e) ||
                  this.remotePlugin.set(e, { src: t, call: n })
                : this.remotePlugin.get(e) ||
              ...
              if (
                ...
                if (
                  (e.channel_domain ||
                    ...
                    (e.channel = "cn")),
                  (this.logger = new X(this.name, e.log)),
                  (this.configManager = new W(this, e)),
                  (this.appBridge = new $(e, this.configManager)),
                  (this.bridgeReport = this.appBridge.bridgeInject()),
                  (this.requestManager = new le(this, e)),
                  (this.logSetting = new he()),
                  (this.debugger = new ve(this, e)),
                  (this.initConfig = e),
                  (this.env = e.channel_domain ? "self" : "public"),
                  ...
                  try {
                    t.plugins.length &&
                      t.plugins.reduce(function (e, t) {
                        var n = t.plugin,
                          i = t.options;
                        if (
                          "stay" === (null == t ? void 0 : t.name) ||
                          "autotrack" === (null == t ? void 0 : t.name)
                        ) {
                    ...
                    console.log("load plugin error, ".concat(e.message)),
                      this.emit(U.DEBUGGER_MESSAGE, {
                        type: U.DEBUGGER_MESSAGE_SDK,
                        info: "SDKåŠ è½½æ’ä»¶å‘ç”Ÿäº†å¼‚å¸¸",
                        level: "error",
                        time: Date.now(),
                        data: e.message,
                        infoType: "sdk",
                  ...
                  this.configManager.set({ app_id: e.app_id }),
                    (this.eventManager = new re()),
                    (this.tokenManager = new se()),
                    (this.sessionManager = new oe()),
                    (this.profileManager = new ue()),
                    (this.extendManager = new ge()),
                    Promise.all([
                    ...
                    this.logSetting.apply(this, e),
                    this.tokenManager.apply(this, e),
                    this.eventManager.apply(this, e),
                    this.sessionManager.apply(this, e),
                    (this.inited = !0),
                    this.emit(V.Init);
              else
                console.warn(
        ...
        (t.prototype.ready = function (e) {
          var n = this;
          try {
            this.extendManager.apply(this, this.initConfig),
              t.plugins.length &&
                t.plugins.reduce(function (e, t) {
                  var o = t.plugin,
                    i = t.options,
                  ...
                  return (
                    a.apply(n, r),
                    e.push(a),
                    n.emit(U.DEBUGGER_MESSAGE, {
                      type: U.DEBUGGER_MESSAGE_SDK,
                      info: "SDKåŠ è½½".concat(t.name, "æ’ä»¶"),
                      level: "info",
                      time: Date.now(),
                      infoType: "sdk",
                    }),
          ...
          (this.sdkReady = !0),
            this.emit(V.Ready),
            this.emit(V.CloudReady, {
              userInfo: this.configManager.get("user"),
            }),
            this.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK ç”¨æˆ·ä¿¡æ¯åˆå§‹åŒ–å®Œæˆ",
              time: Date.now(),
              secType: "USER",
              level: "info",
            ...
            this.logger.info(
              "appid: "
                .concat(e.app_id, ", userInfo:")
                .concat(JSON.stringify(this.configManager.get("user")))
            ),
            this.logger.info(
              "appid: "
                .concat(e.app_id, ", sdk is ready, version is ")
                .concat(B, ", you can report now !!!")
            ),
            this.profileManager.apply(this, e);
          try {
          ...
          this.pageView(),
            this.on(V.TokenChange, function (t) {
              ("webid" !== t.type && "anonymous_id" !== t.type) || n.pageView(),
                n.logger.info(
                  "appid: "
                    .concat(e.app_id, " token change, new userInfo:")
                    .concat(JSON.stringify(n.configManager.get("user")))
                ),
                n.emit(U.DEBUGGER_MESSAGE, {
                  type: U.DEBUGGER_MESSAGE_SDK,
                  info: "SDK è®¾ç½®äº†ç”¨æˆ·ä¿¡æ¯",
                  time: Date.now(),
                  secType: "USER",
                  level: "info",
            ...
            this.on(V.TokenReset, function () {
              n.logger.info(
                "appid: "
                  .concat(e.app_id, " token reset, new userInfo:")
                  .concat(JSON.stringify(n.configManager.get("user")))
              ),
                n.emit(U.DEBUGGER_MESSAGE, {
                  type: U.DEBUGGER_MESSAGE_SDK,
                  info: "SDK é‡ç½®äº†ç”¨æˆ·ä¿¡æ¯",
                  time: Date.now(),
                  secType: "USER",
                  level: "info",
                  data: n.configManager.get("user"),
          ...
          if (this.inited)
            if (t && s(t))
              if (this.bridgeReport) this.appBridge.setConfig(t);
                ...
                t._staging_flag && 1 === t._staging_flag && (this.staging = !0),
                  t.disable_auto_pv &&
                    ((this.disableAutoPageView = !0), delete t.disable_auto_pv);
                var n = e({}, t);
                if (this.initConfig && this.initConfig.configPersist) {
                  var o = this.configManager.getStore();
                  o && (n = Object.assign(o, t)),
                    this.configManager.setStore(t);
                }
                ...
                n.hasOwnProperty("web_id") &&
                  this.emit(V.ConfigWebId, n.web_id),
                  n.hasOwnProperty("user_unique_id") &&
                    this.emit(V.ConfigUuid, n.user_unique_id),
                  this.emit(V.ConfigTransform, n),
                  this.configManager.set(i),
                  this.emit(U.DEBUGGER_MESSAGE, {
                    type: U.DEBUGGER_MESSAGE_SDK,
                    info: "SDK æ‰§è¡ŒConfig",
                    level: "info",
                    time: Date.now(),
                    data: n,
                    infoType: "cus",
        ...
        (t.prototype.event = function (e, t) {
          ...
          try {
            ...
            this.bridgeReport
              ...
              : o.length &&
                (this.emit(V.Event, o), this.emit(V.SessionResetTime)),
              this.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_SDK,
                info: "SDK æ‰§è¡ŒEvent",
                level: "info",
            ...
            this.logger.warn("something error, please check"),
              this.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_SDK,
                info: "SDK æ‰§è¡ŒEventå‘ç”Ÿäº†å¼‚å¸¸",
                level: "error",
                time: Date.now(),
                data: e.message,
                infoType: "sdk",
            ...
            if (Array.isArray(e))
              ...
              i &&
                ...
                this.bridgeReport
                  ...
                  : o.length &&
                    (this.emit(V.BeconEvent, o), this.emit(V.SessionResetTime)),
                this.emit(U.DEBUGGER_MESSAGE, {
                  type: U.DEBUGGER_MESSAGE_SDK,
                  info: "SDK æ‰§è¡ŒBeacon Event",
                  level: "info",
                  time: Date.now(),
                  data: e,
                  infoType: "sdk",
        ...
        (t.prototype.processEvent = function (e, t) {
          ...
          try {
            if (!e)
              return (
                this.logger.warn("eventName is nullï¼Œ please check"), null
              );
            var n = e;
            /^event\./.test(e) && (n = e.slice(6));
            var o = t;
            "object" != typeof o && (o = {}),
              o.profile ? delete o.profile : (o.event_index = h());
            var i = void 0;
            return (
              o.local_ms
                ? ((i = o.local_ms), delete o.local_ms)
                : (i = +new Date()),
              {
                event: n,
                params: o,
        ...
        (t.prototype.predefinePageView = function (t) {
          if ((void 0 === t && (t = {}), this.inited)) {
            var n = {
                ...
                $is_first_time: "".concat(
                  (this.configManager && this.configManager.is_first_time) || !1
                ),
              },
              o = e(e({}, n), t);
            this.event("predefine_pageview", o),
              this.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_SDK,
                info: "SDK ä¸ŠæŠ¥PV",
                level: "info",
        ...
        (t.prototype.setWebIDviaUnionID = function (e) {
          if (e) {
            var t = E(e);
            this.config({ web_id: "".concat(t), wechat_unionid: e }),
        ...
        (t.prototype.setWebIDviaOpenID = function (e) {
          if (e) {
            var t = E(e);
            this.config({ web_id: "".concat(t), wechat_openid: e }),
              this.emit(V.CustomWebId);
          }
        }),
        (t.prototype.setAnonymousId = function (e) {
        ...
        (t.prototype.resetStayDuration = function (e, t, n) {
          void 0 === e && (e = ""),
            void 0 === t && (t = ""),
            void 0 === n && (n = ""),
            this.emit(V.ResetStay, { url_path: e, title: t, url: n }, V.Stay);
        }),
        (t.prototype.resetStayParams = function (e, t, n) {
          void 0 === e && (e = ""),
            void 0 === t && (t = ""),
            void 0 === n && (n = ""),
            this.emit(V.SetStay, { url_path: e, title: t, url: n }, V.Stay);
        }),
            ...
            this.emit(U.DEBUGGER_MESSAGE, {
              ...
              this.sdkReady
                ...
                : (n &&
                  ...
                  this.on(V.Ready, function () {
                    a();
                  }));
          } else this.logger.warn("getToken must be use after function init");
        }),
        (t.prototype.bindToken = function (e, t) {}),
        (t.prototype.setResourceEvent = function (e) {
        ...
        (t.prototype.profileSet = function (e) {
          this.bridgeReport
            ...
            : this.emit(V.ProfileSet, e, V.Profile),
            this.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK æ‰§è¡ŒprofileSet",
              level: "info",
              time: Date.now(),
              data: e,
              infoType: "cus",
        ...
        (t.prototype.profileSetOnce = function (e) {
          this.bridgeReport
            ...
            : this.emit(V.ProfileSetOnce, e, V.Profile),
            this.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK æ‰§è¡ŒprofileSetOnce",
              level: "info",
              time: Date.now(),
              data: e,
              infoType: "cus",
        ...
        (t.prototype.profileIncrement = function (e) {
          this.bridgeReport
            ...
            : this.emit(V.ProfileIncrement, e, V.Profile),
            this.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK æ‰§è¡ŒprofileIncrement",
              level: "info",
              time: Date.now(),
              data: e,
              infoType: "cus",
        ...
        (t.prototype.profileUnset = function (e) {
          this.bridgeReport
            ...
            : this.emit(V.ProfileUnset, e, V.Profile),
            this.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK æ‰§è¡ŒprofileUnset",
              level: "info",
              time: Date.now(),
              data: e,
              infoType: "cus",
        ...
        (t.prototype.profileAppend = function (e) {
          this.bridgeReport
            ...
            : this.emit(V.ProfileAppend, e, V.Profile),
            this.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK æ‰§è¡ŒprofileAppend",
              level: "info",
              time: Date.now(),
              data: e,
              infoType: "cus",
        ...
        (t.prototype.setExternalAbVersion = function (e) {
          this.bridgeReport
            ? this.appBridge.setExternalAbVersion(e)
            : this.emit(
                V.AbExternalVersion,
                "string" == typeof e && e ? "".concat(e).trim() : null,
                V.Ab
              );
        }),
        (t.prototype.getVar = function (e, t, n) {
          this.bridgeReport
            ? this.appBridge.getVar(e, t, n)
            : this.emit(
                V.AbVar,
                { name: e, defaultValue: t, callback: n },
                V.Ab
              );
        }),
        (t.prototype.getAllVars = function (e) {
          this.bridgeReport
            ? this.appBridge.getAllVars(e)
            : this.emit(V.AbAllVars, e, V.Ab);
        }),
        (t.prototype.getABconfig = function (e, t) {
          this.emit(V.AbConfig, { params: e, callback: t }, V.Ab);
        }),
        (t.prototype.getAbSdkVersion = function (e) {
          if (!this.bridgeReport || !e)
        ...
        (t.prototype.onAbSdkVersionChange = function (e) {
          var t = this;
          return (
            this.emit(V.AbVersionChangeOn, e, V.Ab),
            function () {
        ...
        (t.prototype.initCrypto = function () {
          this.publicKey =
            this.initConfig.crypto_publicKey ||
        ...
        (t.prototype.destoryInstace = function () {
          this.destroyInstance ||
            ((this.destroyInstance = !0), this.off(V.TokenComplete));
        }),
        ...
        Object.defineProperty(r, "_fromString", {
          ...
          value: function (e) {
            ...
            for (n = 0; n < r.length; n++)
              (o = r[n].split("=")),
                this.append(i(o[0]), o.length > 1 ? i(o[1]) : "");
          },
        });
  })(
    void 0 !== T
                  ...
                  (o = o.toLowerCase()),
                    ((i = (r =
                      document.implementation.createHTMLDocument(
                        ""
                      )).createElement("base")).href = o),
                    r.head.appendChild(i);
                  try {
                    if (0 !== i.href.indexOf(o)) throw new Error(i.href);
                  } catch (t) {
                    throw new Error(
                      "URL unable to set base " + o + " due to " + t
                    );
                  }
                }
  ...
  function Te(e, t) {
    ...
    if (Object.keys(e).length)
      for (var o in e) {
        if ("filter" === o || "autotrack" === o || "enable_stay_duration" === o)
          break;
        n[o] = e[o];
      }
    (window.opener || window.parent).postMessage(
      { type: "tea:sdk:info", config: n, version: t },
      "*"
    ),
  ...
  var Re = (function () {
    function t() {
      (this.fetchStatus = "no"),
        ...
        (this.readyStatus = !1),
        (this.exposureCache = []),
        (this.auto_exposure = !1);
    }
    return (
      (t.prototype.apply = function (e, t) {
        var n = this;
        if (
          ((this.collect = e), (this.config = t), this.config.enable_ab_test)
        ) {
          ...
          if (!l(o) || o) {
            var i = t.enable_multilink,
              ...
              g = p.storage,
              v = p.fetch;
            (this.cacheStorgae = new g(!1)),
              (this.fetch = v),
              (this.enable_multilink = i),
              (this.enable_ab_visual = a),
              (this.abKey = "__tea_sdk_ab_version_".concat(t.app_id)),
              (this.ab_cross = s),
              (this.ab_cookie_domain = c || ""),
              (this.fetchUrl = ""
                .concat(f)
                .concat("/service/2/abtest_config/")),
              (this.reportUrl = "".concat(e.configManager.getUrl("event"))),
              (this.exposureLimit = t.exposure_limit || 5),
              (this.ab_batch_time = t.ab_batch_time || 50),
              (this.overlay_opacity = t.overlay_opacity || 0),
              (this.auto_exposure = h);
            ...
            this.collect.on(m.TokenChange, function (e) {
              u ||
                ...
                ("uuid" === e.type &&
                  n.readyStatus &&
                  (n.clearCache(), n.fetchAB()));
            }),
              this.collect.on(m.TokenReset, function () {
                u ||
                  (l(o) && !y) ||
                  (n.readyStatus && (n.clearCache(), n.fetchAB()));
              }),
              ...
              this.checkLocal(),
              this.ready("ab"),
              this.readyStatus || (this.fetchAB(), (this.readyStatus = !0)),
              this.collect.emit(m.AbReady);
          }
        }
      }),
      (t.prototype.ready = function (e) {
        var t = this;
        if (
          (this.collect.set(e), this.collect.hook._hooksCache.hasOwnProperty(e))
        ) {
          var n = this.collect.hook._hooksCache[e];
          if (!Object.keys(n).length) return;
          var o = function (e) {
      ...
      (t.prototype.loadMode = function () {
        ...
        if (n) {
          ...
          i
            ? ((this.editMode = !0), (o = i))
            : !r ||
              (-1 === r.indexOf("datatester") &&
                -1 === r.indexOf("visual-editor")) ||
              ((this.editMode = !0), (o = "visual-editor"));
        }
        this.enable_ab_visual &&
        ((function (e, t) {
          ...
          try {
            ...
            if (
              ...
              i || (document.currentScript && (i = document.currentScript.src)),
              i && (n = i.split("/")) && n.length)
            ) {
              o = "https:/";
            ...
            we("tea:openTesterEventInspector", function (t) {
              ...
              if (n) {
                ...
                (window.TEAVisualEditor.__editor_ajax_domain = o || ""),
                  (window.TEAVisualEditor.__ab_appId = r || ""),
                  (window.TEAVisualEditor.lang = i || ""),
                  Oe({
                    event: t,
                    editorUrl: ""
                      .concat(
                        "https://lf3-data.volccdn.com/obj/data-static/log-sdk/collect/tester-event-inspector",
                        ".js?query="
                      )
                      .concat(Date.now()),
                    collectInstance: e,
      ...
      (t.prototype.checkLocal = function () {
        var e = this.getABCache(),
          ...
          i = e.data,
          r = this.checkFromUrl();
        r ? this.mulilinkVersions.push(r) : (this.mulilinkVersions = o || []),
          (this.extVersions = n || []),
          (this.versions = t || []),
          (this.data = i);
      ...
      (t.prototype.updateVersions = function () {
        ...
        this.enable_multilink && (e = e.concat(this.mulilinkVersions)),
          ...
          this.changeListener.size > 0 &&
            this.changeListener.forEach(function (t) {
      ...
      (t.prototype.getVar = function (e, t, n) {
        ...
        var o = { name: e, defaultValue: t, callback: n, type: Ie.Var };
        this.collect.emit(U.DEBUGGER_MESSAGE, {
          type: U.DEBUGGER_MESSAGE_SDK,
          secType: "AB",
          info: "SDK è°ƒç”¨GetVar",
          level: "info",
          time: Date.now(),
          data: e,
          infoType: "cus",
          ...
          "complete" === this.refreshFetchStatus
            ? this.getRealVar(o, e)
      ...
      (t.prototype.getRealVar = function (e, t) {
        ...
        if (r) {
          if (s(r[n])) {
            ...
            return (
              "$ab_url" === t
                ? this.mulilinkVersions.includes(a) ||
                  this.mulilinkVersions.push(a)
                : this.versions.includes(a) || this.versions.push(a),
              this.updateVersions(),
              this.fechEvent(a, t, o),
              i(r[n].val),
              void this.collect.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_SDK,
                secType: "AB",
                info: "SDKæ‰§è¡ŒGetVarï¼Œå¹¶æ›å…‰äº†å®žéªŒ".concat(n),
                level: "info",
                time: Date.now(),
                data: r[n],
                infoType: "sdk",
      ...
      (t.prototype.getAllVars = function (e) {
        if ("function" != typeof e)
          throw new Error("callback must be a function");
        var t = { callback: e, type: Ie.All };
        this.collect.emit(U.DEBUGGER_MESSAGE, {
          type: U.DEBUGGER_MESSAGE_SDK,
          secType: "AB",
          info: "SDK è°ƒç”¨GetAllVars",
          level: "info",
          time: Date.now(),
          infoType: "cus",
        }),
      ...
      (t.prototype.fechEvent = function (e, t, n) {
        try {
          ...
          var c = { events: [s], user: r, header: i };
      ...
      (t.prototype.set = function (e, t) {
        this.ab_cross
          ? this.cacheStorgae.setCookie(e, t, 2592e6, this.ab_cookie_domain)
          : this.cacheStorgae.setItem(e, t),
          this.collect.configManager.setAbCache(t);
      }),
      (t.prototype.remove = function () {
        this.ab_cross
          ? this.cacheStorgae.removeCookie(this.abKey, this.ab_cookie_domain)
            ...
            this.getVar("$ab_modification", window.location.href, function () {
              ...
              (e = r.val),
                ...
                v(
                  ""
                    .concat(
                      "https://lf3-data.volccdn.com/obj/data-static/log-sdk/collect/visual-ab-loader.js",
                      "?query="
                    )
                    .concat(Date.now()),
                  function () {
                ...
                n.collect.emit(U.DEBUGGER_MESSAGE, {
                  type: U.DEBUGGER_MESSAGE_SDK,
                  info: "SDK æ‰§è¡Œå¯è§†åŒ–å®žéªŒ",
                  level: "info",
                  logType: "fetch",
                  time: Date.now(),
                  infoType: "sdk",
                  data: { $ab_modification: r },
                });
            });
                  ...
                  (a !== window.location.href
                    ? setTimeout(function () {
                        if (!n.collect.destroyInstance) {
                          var e = "".concat(a);
                          e =
                            -1 === e.indexOf("http") ? "https://".concat(e) : e;
                          var t = _(e).host;
                          try {
                            var o = new URL(e);
                            t !== location.host
                              ? o.searchParams.append("vid", s)
      ...
      (t.prototype.fetchAB = function (t) {
        ...
        var a = r.user_unique_id,
          s = {
            header: e(e(e({ aid: this.config.app_id }, r || {}), i || {}), {
        ...
        this.collect.requestManager.useRequest({
          ...
          success: function (e) {
            ...
            var o = e.data;
            "success" === e.message
              ? (n.fetchComplete(o, a), t && t(o))
              : (n.fetchComplete(null, a), t && t(null)),
              n.collect.emit(n.types.AbComplete, o),
              n.collect.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_SDK,
                secType: "AB",
                info: "ABå®žéªŒè¯·æ±‚æˆåŠŸ",
                level: "info",
                logType: "fetch",
                time: Date.now(),
                data: o,
          ...
          fail: function () {
            (n.fetchStatus = "complete"),
              (n.refreshFetchStatus = "complete"),
              n.fetchComplete(null, a),
              t && t(null),
              n.collect.emit(n.types.AbTimeout),
              n.collect.emit(U.DEBUGGER_MESSAGE, {
                type: U.DEBUGGER_MESSAGE_SDK,
                secType: "AB",
                info: "ABå®žéªŒè¯·æ±‚ç½‘ç»œå¼‚å¸¸",
                level: "error",
                logType: "fetch",
                time: Date.now(),
                infoType: "sdk",
  ...
  var xe = (function () {
      function t(e, t) {
        (this.maxDuration = 432e5),
          (this.aliveDTime = 6e4),
          (this.options = { aliveName: "predefine_page_alive", params: {} }),
          (this.collect = e),
          (this.config = t),
          (this.pageStartTime = Date.now()),
          (this.sessionStartTime = this.pageStartTime),
          (this.timerHandler = null),
          s(t.enable_stay_duration) &&
            (this.options = Object.assign(
              this.options,
              t.enable_stay_duration
            ));
      }
      return (
        (t.prototype.setParams = function (e, t, n) {
        ...
        (t.prototype.enable = function (e, t, n) {
          (this.url_path = e || this.url_path),
            (this.url = n || this.url),
            (this.title = t || this.title),
            (this.disableCallback = this.enablePageAlive()),
            this.options.params instanceof Function
        ...
        (t.prototype.sendEvent = function (t, n) {
          ...
          o < 0 ||
            o > this.aliveDTime ||
            Date.now() - this.pageStartTime > this.maxDuration ||
            (this.collect.beconEvent(
              this.options.aliveName,
              e(
                {
        ...
        (t.prototype.setUpTimer = function () {
          ...
          return (
            ...
            setInterval(function () {
              Date.now() - e.sessionStartTime > e.aliveDTime &&
                e.sendEvent(!1, !0);
            }, 1e3)
          );
        }),
        (t.prototype.visibilitychange = function () {
          "hidden" === document.visibilityState
            ? this.timerHandler &&
              (clearInterval(this.timerHandler), this.sendEvent(!1))
        ...
        (t.prototype.enablePageAlive = function () {
          ...
          return (
            f(document, "visibilitychange", t, !1),
            f(window, "pagehide", n, !1),
            function () {
              e.beforeunload(),
                p(document, "visibilitychange", t, !1),
                p(window, "beforeunload", n, !1),
                p(window, "pagehide", n, !1);
            }
          );
        }),
        t
    ...
    Ce = (function () {
      function t(e, t) {
        ...
        (this.maxDuration = 432e5),
          (this.aliveDTime = 6e4),
          (this.options = { closeName: "predefine_page_close", params: {} }),
          (this.visibilitychange = function () {
            "hidden" === document.visibilityState
              ? (n.activeEndTime = Date.now())
              : "visible" === document.visibilityState &&
                (n.activeEndTime &&
                  ((n.totalTime += n.activeEndTime - n.activeStartTime),
                  (n.activeTimes += 1)),
          ...
          (this.beforeunload = function () {
            if (
              ((n.totalTime +=
                (n.activeEndTime || Date.now()) - n.activeStartTime),
              n.config.autotrack)
            ) {
              try {
      ...
      return (
        ...
        (t.prototype.resetData = function () {
          (this.activeStartTime =
            void 0 === this.activeStartTime ? this.pageStartTime : Date.now()),
      ...
      return (
        (e.prototype.apply = function (e, t) {
          ...
          if (
            ...
            (this.title = document.title || location.pathname),
              ...
              (this.pageAlive = new xe(e, t)),
              (this.pageClose = new Ce(e, t));
        ...
        (e.prototype.setStayParmas = function (e, t, n) {
          void 0 === e && (e = ""),
            ...
            this.collect.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK æ‰§è¡Œ resetStayParams",
              level: "info",
              time: Date.now(),
              data: { url_path: e, title: t, url: n },
              infoType: "cus",
            });
        }),
        ...
        (e.prototype.resetStayDuration = function (e, t, n) {
          this.reset(e, t, n),
            this.collect.emit(U.DEBUGGER_MESSAGE, {
              type: U.DEBUGGER_MESSAGE_SDK,
              info: "SDK æ‰§è¡Œ resetStayDuration",
              level: "info",
              time: Date.now(),
              data: { url_path: e, title: t, url: n },
              infoType: "sdk",
      ...
      return (
        ...
        (e.prototype.process = function () {
          this.isSessionhasEvent ||
            ((this.isSessionhasEvent = !0), (this.startTime = +new Date()));
          ...
          if (
            ...
            !this.config.channel_domain &&
              !(
                ...
                this.config.disable_sdk_monitor ||
                this.config.enable_encryption
              ))
          ) {
  ...
  var je = function (e) {
    ...
    return (
      e.textContent
        ...
        : e.innerText && (t = e.innerText.trim()),
      ("input" !== e.tagName && "INPUT" !== e.tagName) || (t = e.value || ""),
      t
    );
  };
  function Ve(e) {
        ...
        (this.clickEvent = function (e) {
          (function (e, t) {
            ...
            return !!(
              ...
              (Le(n, "container") ||
                (t.track_attr && Pe(n, t.track_attr)) ||
                Je(n))
            );
          })(e.target, i.options) &&
            i.eventHandel({ eventType: "dom", eventName: "click" }, e);
        }),
          (this.changeEvent = function (e) {
            i.eventHandel({ eventType: "dom", eventName: "change" }, e);
          }),
          (this.submitEvent = function (e) {
            i.eventHandel({ eventType: "dom", eventName: "submit" }, e);
          }),
          (this.getPageViewEvent = function (t, n) {
            n &&
              ...
              i.eventHandel({ eventType: "dom", eventName: "page_view" }, t);
          }),
          ...
          (this.config = o.getConfig().eventConfig),
          (this.collect = n),
          (this.options = t),
          (this.beatTime = t.beat),
          (this.statistics = !1);
      }
      return (
        (t.prototype.init = function (e) {
        ...
        (t.prototype.addListener = function (e) {
          ...
          if (
            "proxy-capturing" === e &&
            (this.config.click &&
              window.document.addEventListener("click", this.clickEvent, !0),
            this.config.change &&
              window.document.addEventListener("change", this.changeEvent, !0),
            this.config.submit &&
              window.document.addEventListener("submit", this.submitEvent, !0),
            this.config.pv &&
              this.collect.on("route-change", function (e) {
                var n = e.config,
                  o = e.name;
            ...
            try {
              ...
              if (r && r.length)
                new PerformanceObserver(function (e) {
                  ...
                  setTimeout(function () {
                    t.statistics ||
                      (t.getPageLoadEvent(r[0].startTime || 0),
                      (t.statistics = !0));
                  }, 2e3);
        ...
        (t.prototype.beatEvent = function (e) {
          ...
          try {
            ...
            this.eventHandel(
              ...
              g(function () {
                t.eventHandel(
                  { eventType: "dom", eventName: "beat", eventSend: "becon" },
                  { beat_type: 0 }
                ),
  ...
  function Qe(e) {
    ...
    return (
      t.forEach(function (e) {
        var t = (function (e) {
            ...
            var t = 0,
              n = e.parentElement;
            if (n)
              for (var o = n.children, i = 0; i < o.length && o[i] !== e; i++)
                o[i].nodeName === e.nodeName && t++;
            return {
      ...
      { element_path: "/".concat(n.join("/")), positions: o }
    );
  }
  function Ye(e, t, n, o) {
    var i = {},
      ...
      a = (function (e, t) {
        ...
        var n = e.clientX,
          ...
          a = n - i >= 0 ? n - i : 0,
          s = o - r >= 0 ? o - r : 0;
        return { touch_x: Math.floor(a), touch_y: Math.floor(s) };
      })(e, r),
      s = r.element_width,
      c = r.element_height,
      l = a.touch_x,
      ...
      d = (function (e) {
        ...
        return (
          (function e(t) {
            ...
            if (
              (o && -1 === n.indexOf(o) && n.push(o), t.childNodes.length > 0)
            )
    ...
    if (
      (window.TEAVisualEditor &&
        ...
        (y = window.TEAVisualEditor.getOriginXpath({ xpath: f, positions: m })),
      (i.element_path = (y && y.xpath) || f),
      (i.positions = (y && y.positions) || m),
      o && !o.text && ((i.texts = d), (i.element_title = je(t))),
      (i.element_id = t.getAttribute("id") || ""),
      (i.element_class_name = t.getAttribute("class") || ""),
      (i.element_type = t.nodeType),
      (i.element_width = Math.floor(s)),
      (i.element_height = Math.floor(c)),
      (i.touch_x = l),
      (i.touch_y = u),
      (i.page_manual_key = ""),
      (i.elememt_manual_key = ""),
      (i.since_page_start_ms = v),
      (i.page_start_ms = g),
      (i.page_path = location.pathname),
      (i.page_host = location.host),
      n.track_attr && Pe(t, n.track_attr))
    ) {
    ...
    if (n.custom_attr)
      try {
        if (Pe(t, n.custom_attr)) {
          (_ = He(t, n.custom_attr)),
            (b = decodeURIComponent(_[n.custom_attr]));
          var E = JSON.parse(b);
          if (Object.keys(E)) for (var S in E) i[S] = E[S];
        }
      } catch (e) {
    ...
    var w = ze(t);
    return (
      "A" === w.tagName && (i.href = w.getAttribute("href")),
      !1 !== n.src &&
        ("IMG" !== t.tagName ||
          t.getAttribute("src").includes("base64") ||
          (i.src = t.getAttribute("src"))),
      i
    );
  }
  var Ze = function (t, n, o, i, r) {
      return e(e({ event: t }, Ye(n, o, i, r)), {
        is_html: 1,
    ...
    et = (function () {
      function t(e, t) {
        (this.ignore = { text: !1 }),
          ...
          t &&
            t.exposure &&
            t.exposure.eventName &&
            (this.eventName.exposure = t.exposure.eventName),
          t &&
            t.scroll &&
            t.scroll.eventName &&
            (this.eventName.scroll = t.scroll.eventName);
      }
      return (
        (t.prototype.handleEvent = function (t, n) {
          try {
            ...
            switch (n) {
              case "click":
                return (
                  (o = this.eventName.click),
                  Ze(o, t, t.target, this.options, this.ignore)
                );
              case "change":
                return e(
                  e({}, Ze((o = "bav2b_change"), t, t.target, this.options)),
                  (function (e, t) {
                    try {
                      if ("bav2b_change" === e)
        ...
        (t.prototype.handleViewEvent = function (e) {
          ...
          try {
            var t =
              ...
              window.sessionStorage.getItem("_tea_cache_duration");
            if (t) {
              var n = JSON.parse(t);
        ...
        (t.prototype.handleStatisticsEvent = function (e) {
          ...
          (t.event = this.eventName.static),
            ...
            (t.page_manual_key =
              this.initConfig.autotrack.page_manual_key || ""),
            (t.refer_page_manual_key = "");
          try {
            var n = e.lcp,
              o = window.performance.timing,
              i = o.loadEventEnd - o.navigationStart;
            (t.page_init_cost_ms = parseInt(n || (i > 0 ? i : 0))),
              (t.page_start_ms = o.navigationStart);
          } catch (e) {
            console.log(
              "page_statistics event error ".concat(JSON.stringify(e))
            );
          }
          return t;
        }),
        ...
        (t.prototype.handleExposureEvent = function (e, t) {
          if (Ve(t.target)) return null;
          var n = Ze(
            e.event || this.eventName.exposure,
            t,
            t.target || t,
            this.options,
            this.ignore
          ...
          if (
            ((n.$exposure_type = e.exposureType),
            this.options.exposure.callback)
          ) {
            var o = this.options.exposure.callback(n);
            return o || Object.keys(o).length
              ? o
              : (console.warn("exposure callback must return data!"), n);
          }
          return n;
        }),
        (t.prototype.handleScrollEvent = function (e, t) {
          var n = Ze(
            e.event || this.eventName.scroll,
            t,
            t.target || t,
            this.options,
            this.ignore
          ...
          if (
            ((n = Object.assign(n, e.params)),
            !this.options.scroll.callback ||
              (n = this.options.scroll.callback(n)) ||
              Object.keys(n).length)
          )
            return n;
  ...
  function st() {
    try {
      var e = (window.TEAVisualEditor.lang =
          window.TEAVisualEditor.lang || O.get(it)),
        t = (window.TEAVisualEditor.__editor_ajax_domain =
          window.TEAVisualEditor.__editor_ajax_domain || O.get(ot)),
        n = (window.TEAVisualEditor.__editor_verison =
          window.TEAVisualEditor.__editor_verison || O.get(rt)),
        o = (window.TEAVisualEditor.__editor_url =
          window.TEAVisualEditor.__editor_url || O.get(at)),
        i = +new Date(),
        r = new Date(i + 18e5);
      O.set(nt, "1", { expires: r }),
        O.set(ot, t, { expires: r }),
        O.set(at, o, { expires: r }),
        O.set(it, e, { expires: r }),
        O.set(rt, n || "", { expires: r });
    } catch (e) {
  ...
  function ut(e, t) {
    ...
    if ((Ee(["*"]), i)) {
      ...
      try {
        ...
        if (
          ...
          r = "https:/";
          for (var l = 2; l < a.length && l !== a.length - 1; l++)
            r += "/".concat(a[l]);
          if (r && r.indexOf("/5.0")) {
            var u = r.split("/5.0");
            r = u[0] || r;
    ...
    if ((Te(t, B), "1" === O.get(nt))) {
      var h = (function () {
        ...
        f = "";
      h && ((window.TEAVisualEditor.__editor_ajax_domain = h), (f = O.get(at))),
        lt({ event: null, editorUrl: f || o, autoTrackInstance: e }),
        st();
    } else
      try {
        we("tea:openVisualEditor", function (t) {
          ...
          if (a) {
            var s = a.referrer,
              c = a.lang;
            if (
              (s && (window.TEAVisualEditor.__editor_ajax_domain = s),
              (n = o),
              i)
            ) {
              var l = a.version,
                u = l
                  ? "/visual-editor-rangers-v".concat(l)
                  : "/visual-editor-rangers-v1.0.0";
              (n = r ? "".concat(r).concat(u, ".js") : o),
                (window.TEAVisualEditor.__editor_verison = l);
            }
            (window.TEAVisualEditor.__editor_url = n),
              (window.TEAVisualEditor.lang = c),
              lt({ event: t, editorUrl: n, autoTrackInstance: e }),
              st();
          }
        }),
    ...
    ft = (function () {
      ...
      return (
          ...
          if (window.MutationObserver)
            try {
              if (
                ...
                return void console.warn(
                  "please use sdk api init after body element"
                );
              ...
              console.log(
                "your browser cannot support MutationObserverï¼Œso cannot report exposure event, please update"
              );
            }
          else
            console.log(
        ...
        (e.prototype.attributeChangeObserve = function (e) {
          e.target.hasAttribute("data-exposure")
            ? this.exposureAdd(e, "mutation")
            : this.exposureRemove(e);
        }),
        (e.prototype.modifyNodeObserve = function (e) {
          var t = this;
          Array.prototype.forEach.call(e.addedNodes, function (e) {
            1 === e.nodeType &&
              e.hasAttribute("data-exposure") &&
              t.exposureAdd(e, "intersect"),
              t.mapChild(e, t.exposureAdd.bind(t));
          }),
            Array.prototype.forEach.call(e.removedNodes, function (e) {
              1 === e.nodeType &&
                e.hasAttribute("data-exposure") &&
                t.exposureRemove(e),
                t.mapChild(e, t.exposureRemove.bind(t));
            });
        }),
  ...
  !(function (e) {
    (e[(e.EXPOSURE_ONCE = 0)] = "EXPOSURE_ONCE"),
      (e[(e.LIFECYCLE_SHOW_NEW = 3)] = "LIFECYCLE_SHOW_NEW"),
      (e[(e.RESUME_FORM_PAGE = 6)] = "RESUME_FORM_PAGE"),
      (e[(e.RESUME_FORM_BACK = 7)] = "RESUME_FORM_BACK"),
      (e[(e.NOT_EXPOSURE = -1)] = "NOT_EXPOSURE");
  })(ht || (ht = {}));
  var pt,
    dt = (function () {
      function e(t, n, o) {
        ...
        (this.backStatus = !1),
          ...
          n.autotrack.exposure.ratio
            ? (this.ratio = n.autotrack.exposure.ratio)
            : 0 === n.autotrack.exposure.ratio
            ? (this.ratio = 0)
            : (this.ratio = 0.5),
          (this.timeLimit = n.autotrack.exposure.stay || 0),
          (this.exposureType = ht.NOT_EXPOSURE),
          (this.eventHandle = o),
          (this.hashMap = new Map()),
          (this.backStatus = !1),
          (this.lastState = null),
          this.collect.on("re-start-sdk", function () {
            i.visibilitychange();
          }),
          this.addListen();
      }
      return (
        (e.prototype.buildObserver = function () {
          var t = this;
          if (e._observer_instance)
            return (
              console.log(
                "your browser cannot support IntersectionObserverï¼Œ so cannot report exposure event, please update"
              ),
              null
            );
          if (window.IntersectionObserver) {
            for (var n = [], o = 0; o <= 1; o += 0.01) n.push(o);
            n.push(1);
            try {
              e._observer_instance = new IntersectionObserver(
                function (e) {
                  e.forEach(function (e) {
                    ...
                    if (
                      ((o.intersectionRatio = i),
                      i <= 0.1 && (e.target.backStatus = !1),
                      ...
                      if (
                        ...
                        var r = setTimeout(function () {
                          try {
                            ...
                            console.log(
                              "IntersectionObserver setTimeout errorï¼Œmsg: ".concat(
                                JSON.stringify(e)
                              )
                            );
                          }
                    ...
                    Date.now() - o.startTime >= t.timeLimit &&
                      !o.exposured &&
                      t.exposureEvent(e, i, n, o);
                  });
                },
              ...
              console.log(
                "IntersectionObserver errorï¼Œmsg: ".concat(JSON.stringify(e))
              );
            }
        ...
        (e.prototype.exposureAdd = function (e, t) {
          ...
          if (o || this.observeMap.has(o)) {
            ...
            if (r && n !== r.instance)
              this.unobserve(n),
                this.observeMap.delete(o),
                (n.observeId = i),
                (n.visible = !1),
                this.observeMap.set(i, {
        ...
        (e.prototype.exposureRemove = function (e) {
          this.observeMap.has(e.observeId) &&
            (this.observeMap.delete(e.observeId),
            this.unobserve(e),
            (e.observeId = ""),
            (e.visible = !1));
        }),
        (e.prototype.exposureEvent = function (e, t, n, o) {
          if (t >= this.ratio) {
            if (
              "0" === e.target.style.opacity ||
              "hidden" === e.target.style.visibility
            )
              return;
        ...
        (e.prototype.visibilitychange = function () {
          ...
          "visible" === document.visibilityState
            ...
            : (clearTimeout(t), (this.customType = void 0));
        }),
          ...
          return (
            e.visible
              ? !1 !== e.backStatus &&
                ...
                ? (this.exposureType = ht.RESUME_FORM_PAGE)
                : (this.exposureType = ht.LIFECYCLE_SHOW_NEW)
              : (e.hasExposure,
                !1 !== e.backStatus &&
                (this.backStatus ||
                  this.customType ||
                  2 === window.performance.navigation.type)
                  ? (this.exposureType = ht.RESUME_FORM_PAGE)
                  : (this.exposureType = ht.EXPOSURE_ONCE)),
            this.exposureType
          );
        }),
        (e.prototype.addListen = function () {
          ...
          if (
            ...
            window.addEventListener("hashchange", function (t) {
              ...
              n && location.href === n.prev
                ? ((e.backStatus = !0), (e.exposureType = ht.RESUME_FORM_PAGE))
                : ((e.backStatus = !1),
                  e.hashMap.set(location.href, {
                    current: t.newURL,
                    prev: t.oldURL,
                  }));
            }),
            ...
            this.collect.on("STATE_CHANGE", function (t) {
              e.lastState = t;
            });
          return (
    ...
    gt = (function () {
      function e(e, t, n) {
        t.autotrack &&
          t.autotrack.exposure &&
          ((this._intersection = new dt(e, t, n)),
          (this._observer = new ft(this._intersection, t)),
          this._intersection && this._observer
            ? this.initObserver()
            : console.log(
                "your browser version cannot support exposure event, please update~"
              ));
      }
      return (
  ...
  !(function (e) {
    (e[(e.SCROLL_UP = 1)] = "SCROLL_UP"),
      (e[(e.SCROLL_DOWN = 2)] = "SCROLL_DOWN"),
      (e[(e.SCROLL_LEFT = 3)] = "SCROLL_LEFT"),
      (e[(e.SCROLL_RIGHT = 4)] = "SCROLL_RIGHT"),
      (e[(e.NOT_SCROLL = -1)] = "NOT_SCROLL");
  })(pt || (pt = {}));
  var vt,
    mt = (function () {
      function e(e, t) {
        (this.distance = 30),
          e.autotrack &&
            e.autotrack.scroll &&
            (e.autotrack.scroll.distance &&
              (this.distance = e.autotrack.scroll.distance),
            (this.eventHandle = t),
            this.addLinstenr(),
            this.mutation());
      }
      return (
        (e.prototype.addLinstenr = function () {
          var e = this;
          Array.prototype.forEach.call(
        ...
        (e.prototype.modifyNodeObserve = function (e) {
          ...
          Array.prototype.forEach.call(e.addedNodes, function (e) {
            1 === e.nodeType &&
              e.hasAttribute("data-scroll") &&
              t.scrollHandle(e),
              t.mapChild(e, t.scrollHandle.bind(t));
          }),
            Array.prototype.forEach.call(e.removedNodes, function (e) {
              1 === e.nodeType &&
                e.hasAttribute("data-scroll") &&
                t.scrollHandle(e, "remove"),
                t.mapChild(e, t.scrollHandle.bind(t));
            });
        }),
        (e.prototype.mapChild = function (e, t) {
          ...
          1 === e.nodeType &&
            e.children.length &&
            Array.prototype.forEach.call(e.children, function (e) {
              1 === e.nodeType && e.hasAttribute("data-scroll") && t(e),
                n.mapChild(e, t);
            });
        }),
            ...
            var o = e.scrollTop,
              ...
              c = function (t) {
                clearTimeout(r),
                  (r = setTimeout(function () {
                    var r = e.scrollTop,
                      ...
                      f =
                        (t.target &&
                          t.target.getAttribute("data-scroll-event")) ||
                        "";
                    1 === u || 2 === u
                      ? r === c &&
                        ((s = c - o),
                        Math.abs(s) >= n.distance &&
                          n.distance &&
                          n.eventHandle(
                            {
                              eventType: "dom",
                ...
                c > o
                  ...
                  : l > i
                  ? (u = pt.SCROLL_LEFT)
                  : l < i && (u = pt.SCROLL_RIGHT);
              };
            return (
              "remove" === t
                ? e.removeEventListener("scroll", c, !1)
                : e.addEventListener("scroll", c, !1),
              function () {
                e.removeEventListener("scroll", c, !1);
              }
            );
    ...
    _t = (function () {
      ...
      return (
        ...
        (e.prototype.ready = function (e) {
          ...
          (t = "object" == typeof t ? t : {}),
            (t = Object.assign(yt, t)),
            (this.destroyed = !1),
            (this.options = t),
            (this.Config = new $e(Xe, this.options)),
            (this.Exposure = new gt(
              this.collect,
              this.config,
              this.handle.bind(this)
            )),
            (this.Scroll = new mt(this.config, this.handle.bind(this))),
            (this.Listener = new We(t, this.collect, this.Config)),
            (this.EventHandle = new et(this.config, t)),
            (this.Request = new tt(this.collect)),
        ...
        (e.prototype.handle = function (e, t) {
          try {
            if (
              this.config.autotrack.collect_url &&
              !this.config.autotrack.collect_url()
            )
              return;
          } catch (e) {}
        ...
        (e.prototype.handleDom = function (e, t) {
          try {
            ...
            if ("click" === n || "change" === n || "submit" === n)
              (a = this.EventHandle.handleEvent(t, n)) &&
                this.Request.send({ eventType: "custom" }, a);
              ...
              (o =
                ...
                this.Request.send({ eventType: "custom" }, o);
            } else if ("beat" === n) {
              var i = this.EventHandle.handleBeadtEvent(t),
                r = e.eventSend;
              i && this.Request.send({ eventType: "custom", eventSend: r }, i);
            } else if ("exposure" === n) {
              (a = this.EventHandle.handleExposureEvent(e, t)) &&
                this.Request.send({ eventType: "custom" }, a);
            } else if ("scroll" === n) {
              var a;
              (a = this.EventHandle.handleScrollEvent(e, t)) &&
                this.Request.send({ eventType: "custom" }, a);
            }
          } catch (e) {
    ...
    St = (function () {
      ...
      return (
        (e.prototype.apply = function (e, t) {
          ...
          if (
            ((this.ready =
              t.app_id && t.enable_tracer && !t.disable_track_event),
            this.ready)
          ) {
            (this.limit = { pv: 1, sdk: 3, autotrack: 3, log: 3 }),
            ...
            var o = this.collect.Types,
              i = e.adapters.fetch;
            (this.fetch = i),
              this.collect.on(o.Event, function () {
                n.addCount("log");
              }),
              ...
              this.listener(),
              this.collect.emit(o.TracerReady);
          }
        }),
        (e.prototype.addCount = function (e, t, n) {
          ...
          try {
            ...
            if (this.tracerCache.has(e)) {
              if ((i = this.tracerCache.get(e)).has(t))
                (o = i.get(t).params.count),
                  o++,
                  i.set(t, this.processTracer(o, e, t));
              else (o = n), i.set(t, this.processTracer(n, e, t));
            } else {
              var i = new Map();
              (o = n),
                i.set(t, this.processTracer(n, e, t)),
                this.tracerCache.set(e, i);
            }
          ...
          try {
            if (e && e.length) {
              ...
              r &&
                r.length &&
                ("f_data" === t
                  ? (o && o.hasOwnProperty("sc")
                      ? this.addCount("log", t, r.length - o.sc)
                      : this.addCount("log", t, r.length),
                    (this.errorCode[t] = n))
                  : r.forEach(function (e) {
                      var o = "log";
                      for (var r in Et)
        ...
        (e.prototype.sendTracer = function (e, t) {
          try {
            ...
            t && window.navigator.sendBeacon
              ? window.navigator.sendBeacon(this.reportUrl, JSON.stringify(n))
  ...
  var kt = (function () {
      ...
      return (
        (e.prototype.apply = function (e, t) {
          ...
          S() ||
            ...
            (this.config = t),
            (this.eventStorage = []),
            this.collector.on("submit-verify-h5", function (e) {
        ...
        (e.prototype.heartbeat = function () {
          ...
          this.heart = setInterval(function () {
            var t = { event: "simulator_test__", local_time_ms: Date.now() },
              n = e.collector.configManager.get(),
              o = n.header,
              i = { events: [t], user: n.user, header: o };
            e.eventStore(i);
          }, 6e4);
        }),
        (e.prototype.eventStore = function (e) {
          this.cleanStatus ||
            (this.verifyReady ? this.postVerify(e) : this.eventStorage.push(e));
        }),
        ...
        (e.prototype.fetchLog = function (e) {
          this.collector.requestManager.useRequest({
            url: ""
              .concat(this.domain, "/simulator/h5/log?connection_key=")
              .concat(this.key),
            data: e,
            timeout: 2e4,
          });
            ...
            function (e, t, n) {
              ...
              (t.exports = l),
                ...
                (l.all = function (e) {
                  ...
                  for (
                    var a = new Array(n), s = 0, c = -1, l = new this(i);
                    ++c < n;
                ...
                (l.race = function (e) {
                  ...
                  var n = e.length,
                    o = !1;
                  if (!n) return this.resolve([]);
                  for (var a, s = -1, c = new this(i); ++s < n; )
                    (a = e[s]),
                      t.resolve(a).then(
                        function (e) {
                          o || ((o = !0), r.resolve(c, e));
          ...
          4: [
            function (e, t, n) {
                    ...
                    return a
                      ...
                      .then(function () {
                        return (function (e) {
                          y(e);
                          for (
                            var t = p[e.name], n = t.forages, o = 0;
                            o < n.length;
                            o++
                          ) {
                            var i = n[o];
              ...
              var I = {
                  ...
                  _initStorage: function (e) {
                    ...
                    i ||
                      ...
                      (p[n.name] = i)),
                      i.forages.push(t),
                      t._initReady || ((t._initReady = t.ready), (t.ready = A));
                    var r = [];
                    function s() {
                      return a.resolve();
                    }
                    ...
                    return a
                      ...
                      .then(function (e) {
                        return (
                          (n.db = e), k(n, t._defaultConfig.version) ? w(n) : e
                        );
                      })
                      .then(function (e) {
                  ...
                  if (
                    ...
                    e &&
                      ("[object ArrayBuffer]" === n ||
                        (e.buffer &&
                          "[object ArrayBuffer]" === F.call(e.buffer))))
                  ) {
                    var o,
                      i = C;
                            ...
                            return new a(function (t, n) {
                              e.db.transaction(
                                function (o) {
                                  ...
                                  for (
                                    var r = [], s = 0, c = e.storeNames.length;
                                    s < c;
                                    s++
                                  )
              ...
              function ee(e, t) {
                ...
                return (
                  e.name && (n = e.name + "/"),
                  e.storeName !== t.storeName && (n += e.storeName + "/"),
                  n
                );
              }
              function te() {
              ...
              var ne = {
                  ...
                  _initStorage: function (e) {
                    ...
                    return (
                      ...
                      te()
                        ? ((this._dbInfo = t), (t.serializer = $), a.resolve())
                        : a.reject()
                    );
                  },
                  _support: (function () {
                      ...
                      n = t.ready().then(function () {
                        for (
                          ...
                          0 === r.indexOf(e.keyPrefix) &&
                            o.push(r.substring(e.keyPrefix.length));
                        }
                        return o;
                      });
                    return s(n, e), n;
                ...
                re = {},
                ae = {},
                se = { INDEXEDDB: I, WEBSQL: Z, LOCALSTORAGE: ne },
                ce = [
                      ...
                      var o = new a(function (t, n) {
                        try {
                          ...
                          var f = function (n) {
                            re[o] &&
                              console.info(
                                "Redefining LocalForage driver: " + o
                              ),
                              (re[o] = e),
                              (ae[o] = n),
                              t();
    ...
    Dt = (function () {
      function e(e, t) {
        return (
          (this.dbStorage = Tt.createInstance({
          ...
          return t(this, void 0, void 0, function () {
            ...
            return n(this, function (n) {
              switch (n.label) {
                case 0:
                  return (
                    n.trys.push([0, 2, , 3]), [4, this.dbStorage.getItem(e)]
                  );
                case 1:
                  (t = n.sent()), (o = t);
                  try {
    ...
    At = (function () {
      function e() {
        (this.errorCache = new Map()),
          ...
          (this.goodCount = 0),
          (this.maxGoodCount = 2),
          (this.maxSilceCount = 50),
          (this.sendStatus = !1),
          (this.firstTrigger = !0),
          (this.degradeStarted = !1),
          (this.backoff_ratio = 0),
          (this.tempId = []);
      }
      return (
        (e.prototype.apply = function (e, t) {
          ...
          try {
            ...
            (this.collect = e),
              (this.config = t),
              (this.storage = new Dt(t.app_id, "DEGRADE_EVENT_STORE")),
              ...
              this.collect.on("http-error", function (e) {
                n.setErrorData(e);
              }),
            ...
            return n(this, function (t) {
              switch (t.label) {
                case 0:
                  return (
                    (e = this),
                    [4, this.storage.getItem(this.eventSleepTimeKey)]
                  );
                case 1:
                  return (
                    (e.sleepTime = t.sent() || this.sleepTime),
            ...
            return n(this, function (n) {
              switch (n.label) {
                case 0:
                  return (
                    n.trys.push([0, 2, , 3]),
                    console.log("degradeInfo", e),
                    (t = e.data),
                    "degrade" === e.status
                      ? (this.addSleep(), [2])
                      : ((this.degradeStarted = !0),
                        (this.collect.degradeStarted = !0),
                        [4, this.setEventStorage(t)])
                  );
                case 1:
                  return (
                    n.sent(),
                    this.tryReportStoreData(),
                ...
                case 2:
                  return (
                    (o = n.sent()),
                    console.log("trigger degrade error", JSON.stringify(o)),
                    [3, 3]
                  );
                case 3:
                  return [2];
            ...
            return n(this, function (t) {
              switch (t.label) {
                case 0:
                  return (
                    t.trys.push([0, 2, , 3]),
                    [4, this.storage.getItem(this.eventKey)]
                  );
                case 1:
                  return (e = t.sent()) && e.size
                    ? ((this.degradeStarted = !0),
                      (this.collect.degradeStarted = !0),
                      this.tryReportStoreData(),
                      [3, 3])
        ...
        (e.prototype.setErrorData = function (e) {
          return t(this, void 0, void 0, function () {
            return n(this, function (t) {
              switch (t.label) {
                case 0:
                  return "degrade" === e.status
                    ? [2]
                    : [4, this.setEventStorage(e)];
                case 1:
                  return t.sent(), [2];
              }
            });
              ...
              switch (n.label) {
                ...
                case 1:
                  return (
                    ...
                    (o = ae()),
                    (i = e.data),
                    console.log("eventS", JSON.stringify(i)),
                    t.set(o, { eventData: i, id: o }),
                    this.setDataToDB(t),
                    [3, 3]
                  );
                case 2:
            ...
            return n(this, function (n) {
              switch (n.label) {
                ...
                case 1:
                  if (
                    ((e = n.sent()),
                    console.log("eventMap", e),
                    (t = new Map()),
                    (i = []),
                    (this.tempId = []),
                    e.size <= this.maxSilceCount)
                  )
                    t = e;
                  else
                    try {
        ...
        (e.prototype.setDataToDB = function (e) {
          try {
            ...
            console.log("set data to DB error", JSON.stringify(t)),
              this.dropEvents(e);
          }
        }),
        (e.prototype.dropEvents = function (e) {
          try {
            ...
            e.forEach(function (e) {
              var t = e.event,
                n = e.local_time_ms;
              i.push({ eventName: t, eventTime: n });
            });
            var r = {
              events: [
                {
                  event: "sdk_monitor",
                  params: JSON.stringify({ storage_fails: i }),
                  local_time_ms: Date.now(),
                },
              ],
              user: n,
                ...
                return t(e, void 0, void 0, function () {
                  ...
                  return n(this, function (t) {
                    switch (t.label) {
                      ...
                      case 1:
                        return (e = t.sent()).length
                          ? 0 !== this.backoff_ratio &&
                            this.backoff_ratio &&
                            this.random() < this.backoff_ratio
                            ? (clearTimeout(this.sleepFn), [2])
                            : (this.fetchData(e), [2])
                          : (clearTimeout(this.sleepFn), [2]);
                    }
                  });
        ...
        (e.prototype.addSleep = function () {
          (this.sendStatus = !1),
            (this.sleepTime = 2 * this.sleepTime),
            this.sleepTime > this.maxTime && (this.sleepTime = this.maxTime),
              ...
              switch (t.label) {
                ...
                case 1:
                  return (
                    ...
                    this.tempId.length &&
                      e &&
                      (this.tempId.forEach(function (t) {
                        e.delete(t);
                      }),
                      (this.tempId = []),
                      this.setDataToDB(e)),
                    this.storage.setItem(
                      this.eventSleepTimeKey,
                      this.sleepTime
                    ),
                    [4, this.reportRest()]
                  );
                ...
                case 3:
                  return (
                    t.sent(), console.warn("reduceDataFromDB error"), [3, 4]
                  );
                case 4:
                  return [2];
              }
    ...
    return (
      ...
      (e.prototype.setKey = function () {
        ...
        (this.storage = new e(!1)),
          (this.cache_key = "__tea_cache_refer_".concat(this.appid)),
          (this.cache = {
            refer_key: "",
          ...
          this.config.autotrack &&
            "object" == typeof this.config.autotrack &&
            this.config.autotrack.page_manual_key &&
            (this.cache.refer_manual_key =
              this.config.autotrack.page_manual_key),
      ...
      (e.prototype.hack = function () {
        ...
        history.pushState = function (n) {
          for (var r = [], a = 1; a < arguments.length; a++)
            r[a - 1] = arguments[a];
          "function" == typeof history.onpushstate &&
            history.onpushstate({ state: n });
          var s = t.call.apply(t, i([history, n], o(r)));
          if (
            (e.collect.emit("STATE_CHANGE", n),
            e.lastLocation === location.href)
          )
            return s;
      ...
      (e.prototype.init = function () {
        ...
        this.collect.emit("route-change", { config: e, init: !0 });
      }),
      (e.prototype.listener = function () {
        var e = this,
          t = null;
      ...
      (e.prototype.sendPv = function (e, t) {
        this.collect.emit("route-change", { config: e, init: !1 });
      }),
  ...
  var Mt = ["getConfig", "getAbSdkVersion"],
    ...
    Ct = (function () {
      ...
      return (
        (e.prototype.processTask = function () {
          var e = this;
          if (this.task.length) {
            var t = this.findIndex(this.task, xt, "0");
            if (-1 !== t) {
              var n = this.processScope(this.task[t][0]).scope;
              this.processMap.set(n, !0),
                this.processCmd.apply(this, i([], o(this.task[t]))),
                (this.newProcessTask = this.task.filter(function (e) {
                  if ("default" === n) {
        ...
        (e.prototype.processCmd = function () {
          ...
          if (c(e)) {
            var n = this.processScope(e[0]),
              o = n.scope,
              i = n.cmd;
            if (!this.processMap.get(o))
              return this.task.push(e), void this.processTask();
            if ((e.splice(0, 1), -1 !== Mt.indexOf(i)))
              return this.callCmd(o, i, e);
            this.callCmd(o, i, e);
          }
        }),
            ...
            if (
              (-1 !== xt.indexOf(t) &&
                (this.collectMap.get(e) ||
                  ((this.collect = new this.Collector(e)),
                  this.collectMap.set(e, this.collect))),
              !this.collectMap.get(e))
            )
              return void console.log(
                "init or use must be first call, cmd:".concat(t)
              );
  ...
  me.usePlugin(Re, "ab"),
    me.usePlugin(Ge, "stay"),
    me.usePlugin(_t, "autotrack"),
    me.usePlugin(At, "degrade"),
    me.usePlugin(kt, "verify_h5"),
    me.usePlugin(Ne, "heartbeat"),
    me.usePlugin(Ue, "monitor"),
    me.usePlugin(It, "route"),
    me.usePlugin(St, "tracer"),
    (function (e) {
      if ("undefined" != typeof window) {
        ...
        if (t && window[t]) {
          ...
          n.sdkLoad
            ? console.log(
                "you page has load sdk file already, do not load another sdk file"
              )
            : ((e.task = n.q || []),
              (window[t] = e.processCmd.bind(e)),
              (window[t].sdkLoad = !0),
              e.processTask());
        }
      }
